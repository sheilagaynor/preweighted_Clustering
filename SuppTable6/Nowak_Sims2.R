...
sim1.test <- function(b, nsim=1100, nkeep=1000) {
  ...
  genesa[1:20, 1:(50-b)] <- genesa[1:20, 1:(50-b)]+6
  genesa[1:20, (51-b):100] <- genesa[1:20, (51-b):100]-6
  genesa[11:30, 26:75] <- genesa[11:30, 26:75]+3
  genesa[11:30, c(1:25,76:100)] <- genesa[11:30, c(1:25,76:100)]-3

  prim1 <- c(rep(1,(50-b)), rep(2,(50+b)))
  prim2 <- c(rep(2,(50-b)), rep(1,(50+b)))
  sec1 <- c(rep(1,25), rep(2, 50), rep(1, 25))
  sec2 <- c(rep(2,25), rep(1, 50), rep(2, 25))
